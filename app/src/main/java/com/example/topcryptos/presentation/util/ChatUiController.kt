...
import com.example.topcryptos.presentation.view.MyMarkerView
...
class ChatUiController @Inject constructor(){
    ...
    fun initChart(chart: LineChart) {
        ...
        chart.marker = MyMarkerView(context, R.layout.layout_marker_view)
        ...
        xl.valueFormatter = ChatDateFormatter()
        xl.labelCount = 3
        xl.granularity = 48F
    ...
    private fun createSet(): LineDataSet {
        ...
        set.highLightColor = ContextCompat.getColor(context, R.color.colorChartAxis)
